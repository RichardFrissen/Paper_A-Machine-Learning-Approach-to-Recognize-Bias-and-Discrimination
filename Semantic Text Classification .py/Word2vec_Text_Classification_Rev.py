...
print('Starting Word2Vec script. Starting at {}\n'.format(timenow))
...
##
##timenow = datetime.now().strftime('%c')
##print('Word2Vec word embedding - Start baseline. Starting at {}\n'.format(timenow))
##
...
##
##timenow = datetime.now().strftime('%c')
##print('Word2Vec word embedding - Start LR. Starting at {}\n'.format(timenow))
##
...
timenow = datetime.now().strftime('%c')
print('Word2Vec word embedding - Start DT. Starting at {}\n'.format(timenow))
...
timenow = datetime.now().strftime('%c')
print('Word2Vec word embedding - Start NB. Starting at {}\n'.format(timenow))
