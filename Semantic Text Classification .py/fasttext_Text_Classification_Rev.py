...
print('Starting fasttext script. Starting at {}\n'.format(timenow))
...
##
##timenow = datetime.now().strftime('%c')
##print('Fasttext word embedding - Start baseline. Starting at {}\n'.format(timenow))
##
...
##
##timenow = datetime.now().strftime('%c')
##print('Fasttext word embedding - Start LR. Starting at {}\n'.format(timenow))
##
...
timenow = datetime.now().strftime('%c')
print('Fasttext word embedding - Start DT. Starting at {}\n'.format(timenow))
...
timenow = datetime.now().strftime('%c')
print('Fasttext word embedding - Start NB. Starting at {}\n'.format(timenow))
