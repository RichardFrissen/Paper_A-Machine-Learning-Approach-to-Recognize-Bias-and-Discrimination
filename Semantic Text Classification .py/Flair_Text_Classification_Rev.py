...
print('Starting flair script. Starting at {}\n'.format(timenow))
...
##
##timenow = datetime.now().strftime('%c')
##print('Flair word embedding - Start baseline. Starting at {}\n'.format(timenow))
##
...
##
##timenow = datetime.now().strftime('%c')
##print('Flair word embedding - Start LR. Starting at {}\n'.format(timenow))
##
...
timenow = datetime.now().strftime('%c')
print('Flair word embedding - Start DT. Starting at {}\n'.format(timenow))
...
timenow = datetime.now().strftime('%c')
print('Flair word embedding - Start NB. Starting at {}\n'.format(timenow))
